...
inputLine.value = 0;
btnEqual.disabled = false;
const btnGrey = document.querySelectorAll(".grey");
const btnMemoryPlus = document.querySelector(".memoryPlus");
const btnMemoryMinus = document.querySelector(".memoryMinus");
const btnMemory = document.querySelector(".memory");
